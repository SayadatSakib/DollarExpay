...
<?php
    ...
    $query = "Select * from buy_table where user_email='$umails' order by id DESC";
...
<?php include 'inc/header.php';?>
    ...
    <div id="body">
		...
		<div class="card" style="margin-left: 10px; margin-right: 10px; background: #1b053e94;">
		  ...
		  <div class="card-body">
              <div>
                <label style="color: white; font-weight: bold">Your Buy Transections:</label>
              </div>
                                        ...
                                        <?php
                                            foreach($result as $key=>$res){
                                                echo "<tr >";
                                                    ...
                                                    echo "<td>".$res['TRX_ID']."</td>";
                                                    echo "<td>".$res['receive_currency']."</td>";
